...
- **Actionlint etter CI-endring:** Etter *kvar* endring i `.github/workflows/*.yml` skal `actionlint` køyrast mot den endra fila før arbeidet vert rekna som ferdig — kommando og grunngjeving lastar automatisk ved arbeid med desse filene, sjå `.claude/rules/ci-workflows.md`.
