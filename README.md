...
| [AP-NO](https://brreg.github.io/linkml-datamodellering-no/ap-no/) | [dqv-core](https://brreg.github.io/linkml-datamodellering-no/ap-no/dqv-core/) | DQV-kjerneklassar og -slots utan referanse til dcat-ap-no. Denne fila vert importert av dcat-ap-no for å gje tilgang til Kvalitetsmerknad og Kvalitetsmaaling på Datasett, utan å skape sirkulær import. dqv-ap-no importerer dcat-ap-no og narrowar har_maal.range via slot_usage. | 
...
| [OREG](https://brreg.github.io/linkml-datamodellering-no/oreg/) | [lunchregisteret](https://brreg.github.io/linkml-datamodellering-no/oreg/lunchregisteret/) | Generert modell for 'lunchregisteret'. | 
...
| [FINT](https://brreg.github.io/linkml-datamodellering-no/fint/) | [fint-common](https://brreg.github.io/linkml-datamodellering-no/fint/fint-common/) | Felles klassar for FINT | 
