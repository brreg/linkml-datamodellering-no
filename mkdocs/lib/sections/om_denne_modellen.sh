...
generate_description() {
    ...
    echo "> Denne sida dokumenterer LinkML-modellen $schema, inkludert klassar, eigenskapar, datatypar, valideringsresultat og genererte artefakt. Informasjonen er generert automatisk frå skjemaet og tilhøyrande byggeproses."
    echo ""
