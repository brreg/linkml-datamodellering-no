...
| [frekvens](frekvens.md) | 0..1 <br/> [Konsept](konsept.md) | Oppdateringsfrekvens for datasettet. |
  ...
  frekvens:
    ...
    annotations:
      ...
      enum_dekning:
        tag: enum_dekning
        value: full
    description: Oppdateringsfrekvens for datasettet. Verdien SKAL veljast frå EUs
      kontrollerte vokabular Frequency (http://publications.europa.eu/resource/authority/frequency/).
      Sjå enumerasjonen DCTFrequency i common-ap-no for alle tilgjengelege verdiar
      (DAILY, WEEKLY, MONTHLY, ANNUAL, CONTINUOUS, osv.).
    in_subset:
    - Valgfri
    from_schema: https://data.norge.no/ap-no/dcat-ap-no
