...
| [type_concept](type_concept.md) | 0..1 <br/> [Konsept](konsept.md) | Type aktør frå ADMS publisher type-vokabularet. |
...
slot_usage:
  ...
  type_concept:
    ...
    annotations:
      gyldige_verdier:
        tag: gyldige_verdier
        value: http://purl.org/adms/publishertype/
      vokabular_krav:
        tag: vokabular_krav
        value: bør
      enum_referanse:
        tag: enum_referanse
        value: ADMSPublisherType
      enum_dekning:
        tag: enum_dekning
        value: full
    description: Type aktør frå ADMS publisher type-vokabularet. Verdien BØR veljast
      frå http://purl.org/adms/publishertype/ (t.d. NationalAuthority, LocalAuthority,
      Company). Sjå enumerasjonen ADMSPublisherType i common-ap-no.
    in_subset:
    - Anbefalt
