...
```yaml
imports:
  - https://raw.githubusercontent.com/brreg/linkml-datamodellering-no/referansemodell-v1.3.0/src/linkml/referanse/referansemodell/referansemodell-schema
```
...
> *Usage* "Definert lokalt" betyr at eigenskapen er definert lokalt. "Brukt lokalt" betyr at eigenskapen er brukt lokalt i modellen.
#### Verdiar (4)
...
> *Usage* "Definert lokalt" betyr at verdiområdet er definert lokalt. "Brukt lokalt" betyr at verdiområdet er brukt lokalt i modellen.
...
> *Usage* "Definert lokalt" betyr at verdiformatet er definert lokalt. "Brukt lokalt" betyr at verdiformatet er brukt lokalt i modellen.
...
> *Usage* "Definert lokalt" betyr at klassifiseringa er definert lokalt. "Brukt lokalt" betyr at klassifiseringa er brukt lokalt i modellen.
