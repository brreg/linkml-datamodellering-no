...
_Temavokabular som vert brukt i katalogen. Inkluder Los-referansen (https://psi.norge.no/los/) for å signalisere til Felles datakatalog at Los vert brukt._
...
```yaml
name: temaer
description: Temavokabular som vert brukt i katalogen. Inkluder Los-referansen (https://psi.norge.no/los/)
  for å signalisere til Felles datakatalog at Los vert brukt.
