...
_Namn eller tittel på ressursen._
...
| --- | --- | --- |
| [Standard](standard.md) | Ein standard eller spesifikasjon ein ressurs er i samsvar med |  yes  |
...
| Domain Of | [Standard](standard.md), [RegulativRessurs](regulativressurs.md), [Distribusjon](distribusjon.md), [Datasett](datasett.md), [Datasettserie](datasettserie.md), [Datatjeneste](datatjeneste.md), [Katalogpost](katalogpost.md), [Katalog](katalog.md), [Ressurs](ressurs.md) |
...
| ---  | ---  |
| self | dct:title |
| native | https://example.org/linkml/referanse/tittel |
