...
_Kode for kva del av bygningen eit bruksenhetsnummer refererer til._



URI: [https://data.norge.no/linkml/ngr-adresse/Etasjeplan](https://data.norge.no/linkml/ngr-adresse/Etasjeplan)

## Permissible Values
| Value | Meaning | Description |
| --- | --- | --- |
| H | None | Høgde (over bakkenivå) |
| U | None | Under bakkenivå |
| K | None | Kjellar |
| L | None | Loft |
| M | None | Mesanin |
