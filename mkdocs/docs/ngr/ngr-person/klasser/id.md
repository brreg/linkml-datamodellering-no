...
URI: [https://data.norge.no/linkml/ngr-person/id](https://data.norge.no/linkml/ngr-person/id)
Alias: id
...
| Domain Of | [Person](person.md), [Personnavn](personnavn.md), [Folkeregisteridentifikator](folkeregisteridentifikator.md), [Personidentifikasjon](personidentifikasjon.md), [FalskIdentitet](falskidentitet.md), [Identifikasjonsdokument](identifikasjonsdokument.md), [Identitetsgrunnlag](identitetsgrunnlag.md), [Kjoenn](kjoenn.md), [Sivilstand](sivilstand.md), [Personstatus](personstatus.md), [Statsborgerskap](statsborgerskap.md), [Opphold](opphold.md), [Foedsel](foedsel.md), [Dodsfall](dodsfall.md), [KontaktinformasjonDoedsbo](kontaktinformasjondoedsbo.md), [ForeldreansvarForelder](foreldreansvarforelder.md), [ForeldreansvarBarn](foreldreansvarbarn.md), [FamilierelasjonForelder](familierelasjonforelder.md), [FamilierelasjonBarn](familierelasjonbarn.md), [FamilierelasjonEktefelle](familierelasjonektefelle.md), [InnflyttingTilNorge](innflyttingtilnorge.md), [UtflyttingFraNorge](utflyttingfranorge.md), [GeografiskAdresse](geografiskadresse.md), [Adressebeskyttelse](adressebeskyttelse.md), [Verge](verge.md), [RettsligHandleevne](rettslighandleevne.md), [ReservasjonMotKommunikasjonPaaNett](reservasjonmotkommunikasjonpaanett.md), [Kontaktopplysninger](kontaktopplysninger.md), [SpraakForElektroniskKommunikasjon](spraakforelektroniskkommunikasjon.md) |
...
| ---  | ---  |
| self | https://data.norge.no/linkml/ngr-person/id |
| native | https://data.norge.no/linkml/ngr-person/id |
