...
URI: [https://data.norge.no/linkml/ngr-person/VergetypeKode](https://data.norge.no/linkml/ngr-person/VergetypeKode)

## Permissible Values
| Value | Meaning | Description |
| --- | --- | --- |
| ENSLIG_MINDREAARIG_ASYLSOEKER | None | Einsleg mindreårig asylsøkjar |
| MINDREAARIG | None | Mindreårig |
| VOKSEN | None | Vaksen |
| MIDLERTIDIG_FOR_VOKSEN | None | Mellombels for vaksen |
