...
_Kjønn registrert på personen._
...
| Slot URI | [ngrp:harKjoenn](https://data.norge.no/vocabulary/ngr-person#harKjoenn) |
...
| ---  | ---  |
| self | ngrp:harKjoenn |
| native | https://data.norge.no/linkml/ngr-person/har_kjoenn |
