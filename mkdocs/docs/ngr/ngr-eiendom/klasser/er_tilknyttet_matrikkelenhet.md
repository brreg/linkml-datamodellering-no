...
# Slot: er_tilknyttet_matrikkelenhet 


_Matrikkeleininga brukseininga er knytt til._
...
| ---  | ---  |
| self | ngre:erTilknyttetMatrikkelenhet |
| native | https://data.norge.no/linkml/ngr-eiendom/er_tilknyttet_matrikkelenhet |
