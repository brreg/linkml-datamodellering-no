...
URI: [https://data.norge.no/linkml/ngr-eiendom/andreMatrikkelenheter](https://data.norge.no/linkml/ngr-eiendom/andreMatrikkelenheter)
...
| ---  | ---  |
| self | https://data.norge.no/linkml/ngr-eiendom/andreMatrikkelenheter |
| native | https://data.norge.no/linkml/ngr-eiendom/andreMatrikkelenheter |
