...
| [ngr-person](ngr-person/index.md) | SHACL shapes · JSON-LD kontekst · JSON Schema · OWL ontologi · RDF/Turtle skjema · Python-klasser · ER-diagram (Mermaid) · Eksempeldata (Turtle) |
| [ngr-virksomhet](ngr-virksomhet/index.md) | SHACL shapes · JSON-LD kontekst · JSON Schema · OWL ontologi · RDF/Turtle skjema · Python-klasser · ER-diagram (Mermaid) · Eksempeldata (Turtle) |
