...
| [Byggmanifest (build.yaml)](build-config.md) | Du treng referanse for kva `build.yaml` styrer — kva artefaktar som vert genererte, publiseringsflagg og valideringspolicy. |
...
- [Arkitektur](arkitektur.md) — korleis skjemaa heng saman
- [Publisering](publisering.md) — korleis genererte artefakt vert tilrettelagt for hausting til nasjonale katalogar
- [Automasjon](automasjon.md) — tekniske detaljar om genereringspipelinen og monitorering
