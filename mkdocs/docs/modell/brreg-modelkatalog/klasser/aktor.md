...
| [ModelkatalogContainer](modelkatalogcontainer.md) | [aktorer](aktorer.md) | range | [Aktor](aktor.md) |
...
```
### Example: Aktor-modellforvaltning

```yaml
id: https://brreg.no/kontakt/modellforvaltning
namn_aktor:
- Registerenheten i Brønnøysund – Modellforvaltning
