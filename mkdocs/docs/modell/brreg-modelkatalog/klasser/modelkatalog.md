...
| [ModelkatalogContainer](modelkatalogcontainer.md) | [modelkatalogar](modelkatalogar.md) | range | [Modelkatalog](modelkatalog.md) |
...
## Examples
### Example: Modelkatalog-brreg-modelkatalog

```yaml
id: https://brreg.no/modellkatalogar/brreg-modelkatalog
tittel:
- Brønnøysundregistra – Modelkatalog
beskrivelse:
- Informasjonsmodellar frå Brønnøysundregistra i LinkML-format, tilgjengeleg som SHACL,
  JSON Schema, OWL og RDF/Turtle.
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog
...
- https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-eiendom
- https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-person
- https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-virksomhet
- https://brreg.no/modellkatalogar/brreg-modelkatalog/register-over-aksjeeiere
- https://brreg.no/modellkatalogar/brreg-modelkatalog/samt-bu
modell:
- https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-adresse
- https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-eiendom
- https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-person
