...
| [ModelkatalogContainer](modelkatalogcontainer.md) | [informasjonsmodellar](informasjonsmodellar.md) | range | [Informasjonsmodell](informasjonsmodell.md) |
...
## Examples
### Example: Informasjonsmodell-ngr-adresse
...
beskrivelse:
- Informasjonsmodell for offisielle adresser frå Matrikkelen.
utgiver: https://data.norge.no/organizations/974760673
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-adresse
informasjonsmodellidentifikator: https://brreg.github.io/linkml-datamodellering-no/ngr/ngr-adresse/
kontaktpunkt:
...
```
### Example: Informasjonsmodell-ngr-eiendom

```yaml
id: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-eiendom
tittel:
- Nasjonale grunndata – Eiendom
beskrivelse:
- Informasjonsmodell for fast eigedom, matrikkeleining og bygning.
utgiver: https://data.norge.no/organizations/974760673
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-eiendom
informasjonsmodellidentifikator: https://brreg.github.io/linkml-datamodellering-no/ngr/ngr-eiendom/
kontaktpunkt:
- https://brreg.no/kontakt/modellforvaltning
tema:
- https://psi.norge.no/los/tema/bolig-og-eiendom
...
```
### Example: Informasjonsmodell-ngr-person

```yaml
id: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-person
tittel:
- Nasjonale grunndata – Person
beskrivelse:
- Informasjonsmodell for person, identifikasjon og familierelasjonar.
utgiver: https://data.norge.no/organizations/974760673
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-person
informasjonsmodellidentifikator: https://brreg.github.io/linkml-datamodellering-no/ngr/ngr-person/
kontaktpunkt:
- https://brreg.no/kontakt/modellforvaltning
tema:
- https://psi.norge.no/los/tema/familie-og-sivilstand
lisens: http://publications.europa.eu/resource/authority/licence/CC_BY_4_0

```
### Example: Informasjonsmodell-ngr-virksomhet

```yaml
id: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-virksomhet
tittel:
- Nasjonale grunndata – Virksomhet
beskrivelse:
- Informasjonsmodell for verksemder, roller og organisasjonsstruktur.
utgiver: https://data.norge.no/organizations/974760673
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog/ngr-virksomhet
informasjonsmodellidentifikator: https://brreg.github.io/linkml-datamodellering-no/ngr/ngr-virksomhet/
kontaktpunkt:
- https://brreg.no/kontakt/modellforvaltning
tema:
...
```
### Example: Informasjonsmodell-register-over-aksjeeiere

```yaml
id: https://brreg.no/modellkatalogar/brreg-modelkatalog/register-over-aksjeeiere
tittel:
- Register over aksjeeigarar
beskrivelse:
- Informasjonsmodell for aksjeeigarar, aksjekapital og eigarstruktur.
utgiver: https://data.norge.no/organizations/974760673
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog/register-over-aksjeeiere
informasjonsmodellidentifikator: https://brreg.github.io/linkml-datamodellering-no/oreg/register-over-aksjeeiere/
kontaktpunkt:
- https://brreg.no/kontakt/modellforvaltning
tema:
- https://psi.norge.no/los/tema/naering-og-sysselsetting
...
```
### Example: Informasjonsmodell-samt-bu

```yaml
id: https://brreg.no/modellkatalogar/brreg-modelkatalog/samt-bu
tittel:
- SAMT – Barnehagar og skular
beskrivelse:
- Informasjonsmodell for barnehagar og skular i kommunesektoren.
utgiver: https://data.norge.no/organizations/974760673
identifikator_literal: https://brreg.no/modellkatalogar/brreg-modelkatalog/samt-bu
informasjonsmodellidentifikator: https://brreg.github.io/linkml-datamodellering-no/samt/samt-bu/
kontaktpunkt:
- https://brreg.no/kontakt/modellforvaltning
tema:
- https://psi.norge.no/los/tema/familie-og-sivilstand
