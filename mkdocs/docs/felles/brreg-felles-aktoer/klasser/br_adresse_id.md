...
URI: [brreg_felles_adresse:brAdresseId](https://data.norge.no/felles/brreg-felles-adresse/brAdresseId)
...
| Slot URI | [brreg_felles_adresse:brAdresseId](https://data.norge.no/felles/brreg-felles-adresse/brAdresseId) |
...
| ---  | ---  |
| self | brreg_felles_adresse:brAdresseId |
| native | https://data.norge.no/felles/brreg-felles-adresse/br_adresse_id |
