...
URI: [brreg_felles_adresse:domenenavn](https://data.norge.no/felles/brreg-felles-adresse/domenenavn)
...
| Slot URI | [brreg_felles_adresse:domenenavn](https://data.norge.no/felles/brreg-felles-adresse/domenenavn) |
...
| ---  | ---  |
| self | brreg_felles_adresse:domenenavn |
| native | https://data.norge.no/felles/brreg-felles-adresse/domenenavn |
