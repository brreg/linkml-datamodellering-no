...
URI: [brreg_felles_adresse:adressenummerTekst](https://data.norge.no/felles/brreg-felles-adresse/adressenummerTekst)
...
| Slot URI | [brreg_felles_adresse:adressenummerTekst](https://data.norge.no/felles/brreg-felles-adresse/adressenummerTekst) |
...
| ---  | ---  |
| self | brreg_felles_adresse:adressenummerTekst |
| native | https://data.norge.no/felles/brreg-felles-adresse/adressenummer_tekst |
