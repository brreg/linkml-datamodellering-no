...
URI: [brreg_felles_adresse:stedsnavn](https://data.norge.no/felles/brreg-felles-adresse/stedsnavn)
...
| Slot URI | [brreg_felles_adresse:stedsnavn](https://data.norge.no/felles/brreg-felles-adresse/stedsnavn) |
...
| ---  | ---  |
| self | brreg_felles_adresse:stedsnavn |
| native | https://data.norge.no/felles/brreg-felles-adresse/stedsnavn |
