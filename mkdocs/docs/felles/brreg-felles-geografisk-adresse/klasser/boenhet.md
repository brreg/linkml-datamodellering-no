...
_Bueining/leilegheitsnummer._





URI: [brreg_felles_geografisk_adresse:boenhet](https://data.norge.no/felles/brreg-felles-geografisk-adresse/boenhet)
...
| Slot URI | [brreg_felles_geografisk_adresse:boenhet](https://data.norge.no/felles/brreg-felles-geografisk-adresse/boenhet) |
...
| ---  | ---  |
| self | brreg_felles_geografisk_adresse:boenhet |
| native | https://data.norge.no/felles/brreg-felles-geografisk-adresse/boenhet |
