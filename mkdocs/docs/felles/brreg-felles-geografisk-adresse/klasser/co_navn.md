...
URI: [brreg_felles_geografisk_adresse:coNavn](https://data.norge.no/felles/brreg-felles-geografisk-adresse/coNavn)
...
| Slot URI | [brreg_felles_geografisk_adresse:coNavn](https://data.norge.no/felles/brreg-felles-geografisk-adresse/coNavn) |
...
| ---  | ---  |
| self | brreg_felles_geografisk_adresse:coNavn |
| native | https://data.norge.no/felles/brreg-felles-geografisk-adresse/co_navn |
