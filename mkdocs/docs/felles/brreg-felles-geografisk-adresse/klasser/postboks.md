...
_Postboksnummer (utanlandsk format)._





URI: [brreg_felles_geografisk_adresse:postboks](https://data.norge.no/felles/brreg-felles-geografisk-adresse/postboks)
...
| Slot URI | [brreg_felles_geografisk_adresse:postboks](https://data.norge.no/felles/brreg-felles-geografisk-adresse/postboks) |
...
| ---  | ---  |
| self | brreg_felles_geografisk_adresse:postboks |
| native | https://data.norge.no/felles/brreg-felles-geografisk-adresse/postboks |
