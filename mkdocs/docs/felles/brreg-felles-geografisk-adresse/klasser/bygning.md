...
_Bygningsnamn eller -nummer._





URI: [brreg_felles_geografisk_adresse:bygning](https://data.norge.no/felles/brreg-felles-geografisk-adresse/bygning)
...
| Slot URI | [brreg_felles_geografisk_adresse:bygning](https://data.norge.no/felles/brreg-felles-geografisk-adresse/bygning) |
...
| ---  | ---  |
| self | brreg_felles_geografisk_adresse:bygning |
| native | https://data.norge.no/felles/brreg-felles-geografisk-adresse/bygning |
