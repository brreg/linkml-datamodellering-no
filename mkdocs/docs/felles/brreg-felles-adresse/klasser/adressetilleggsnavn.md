...
URI: [brreg_felles_adresse:adressetilleggsnavn](https://data.norge.no/felles/brreg-felles-adresse/adressetilleggsnavn)
...
| Slot URI | [brreg_felles_adresse:adressetilleggsnavn](https://data.norge.no/felles/brreg-felles-adresse/adressetilleggsnavn) |
...
| ---  | ---  |
| self | brreg_felles_adresse:adressetilleggsnavn |
| native | https://data.norge.no/felles/brreg-felles-adresse/adressetilleggsnavn |
