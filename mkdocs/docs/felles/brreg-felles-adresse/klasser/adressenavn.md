...
URI: [brreg_felles_adresse:adressenavn](https://data.norge.no/felles/brreg-felles-adresse/adressenavn)
...
| Slot URI | [brreg_felles_adresse:adressenavn](https://data.norge.no/felles/brreg-felles-adresse/adressenavn) |
...
| ---  | ---  |
| self | brreg_felles_adresse:adressenavn |
| native | https://data.norge.no/felles/brreg-felles-adresse/adressenavn |
