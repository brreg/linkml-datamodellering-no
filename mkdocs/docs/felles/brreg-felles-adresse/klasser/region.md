...
_Region, delstat eller provins._





URI: [brreg_felles_adresse:region](https://data.norge.no/felles/brreg-felles-adresse/region)
...
| Slot URI | [brreg_felles_adresse:region](https://data.norge.no/felles/brreg-felles-adresse/region) |
...
| ---  | ---  |
| self | brreg_felles_adresse:region |
| native | https://data.norge.no/felles/brreg-felles-adresse/region |
