...
URI: [brreg_felles_adresse:kommune](https://data.norge.no/felles/brreg-felles-adresse/kommune)
...
| Slot URI | [brreg_felles_adresse:kommune](https://data.norge.no/felles/brreg-felles-adresse/kommune) |
...
| ---  | ---  |
| self | brreg_felles_adresse:kommune |
| native | https://data.norge.no/felles/brreg-felles-adresse/kommune |
