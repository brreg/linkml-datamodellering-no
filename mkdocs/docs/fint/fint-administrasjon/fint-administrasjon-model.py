...
# Generation date: 2026-06-09T16:28:14
...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/fint/fint-administrasjon/')
...
class AdministrasjonContainer(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/AdministrasjonContainer")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "AdministrasjonContainer"
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/AdministrasjonContainer")
...
class Lonn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Lonn")
...
class Kontostreng(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Kontostreng")
...
class Fastlonn(Lonn):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fastlonn")
...
class Fasttillegg(Lonn):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fasttillegg")
...
class Variabellonn(Lonn):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Variabellonn")
...
class Fravaer(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fravaer")
...
class Fullmakt(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fullmakt")
...
class Rolle(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Rolle")
...
class Arbeidslokasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Arbeidslokasjon")
...
class Organisasjonselement(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Organisasjonselement")
...
class Personalressurs(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Personalressurs")
...
class Arbeidsforhold(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Arbeidsforhold")
...
class Aktoer(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Aktoer")
...
class Begrep(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Begrep")
...
class Aktivitet(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Aktivitet")
...
class Anlegg(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Anlegg")
...
class Ansvar(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Ansvar")
...
class Art(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Art")
...
class Arbeidsforholdstype(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Arbeidsforholdstype")
...
class Diverse(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Diverse")
...
class Formaal(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Formaal")
...
class Fravaersgrunn(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fravaersgrunn")
...
class Fravaerstype(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fravaerstype")
...
class Funksjon(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Funksjon")
...
class Kontrakt(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Kontrakt")
...
class Lonsart(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Lonsart")
...
class Lopenummer(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Lopenummer")
...
class Objekt(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Objekt")
...
class Organisasjonstype(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Organisasjonstype")
...
class Personalressurskategori(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Personalressurskategori")
...
class Prosjekt(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Prosjekt")
...
class Prosjektart(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Prosjektart")
...
class Ramme(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Ramme")
...
class Stillingskode(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Stillingskode")
...
class Uketimetall(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Uketimetall")
...
class Elev(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Elev")
...
class Enhet(Aktoer):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Enhet")
...
class Identifikator(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Identifikator")
...
class Periode(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Periode")
...
class Personnavn(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Personnavn")
...
class Kontaktinformasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Kontaktinformasjon")
...
class Adresse(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Adresse")
...
class Matrikkelnummer(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Matrikkelnummer")
...
class Landkode(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Landkode")
...
class Kjonn(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Kjonn")
...
class Fylke(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Fylke")
...
class Kommune(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Kommune")
...
class Spraak(Begrep):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Spraak")
...
class Valuta(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Valuta")
...
class Person(Aktoer):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Person")
...
class Kontaktperson(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Kontaktperson")
...
class Virksomhet(Enhet):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/fint/fint-administrasjon/Virksomhet")
...
slots.anvist = Slot(uri=ADM.anvist, name="anvist", curie=ADM.curie('anvist'),
                   model_uri=DEFAULT_.anvist, domain=None, range=Optional[Union[str, XSDDateTime]])

slots.attestert = Slot(uri=ADM.attestert, name="attestert", curie=ADM.curie('attestert'),
                   model_uri=DEFAULT_.attestert, domain=None, range=Optional[Union[str, XSDDateTime]])
...
slots.kontert = Slot(uri=ADM.kontert, name="kontert", curie=ADM.curie('kontert'),
                   model_uri=DEFAULT_.kontert, domain=None, range=Optional[Union[str, XSDDateTime]])

slots.kontostreng = Slot(uri=ADM.kontostreng, name="kontostreng", curie=ADM.curie('kontostreng'),
                   model_uri=DEFAULT_.kontostreng, domain=None, range=Optional[Union[dict, Kontostreng]])

slots.opptjent = Slot(uri=ADM.opptjent, name="opptjent", curie=ADM.curie('opptjent'),
                   model_uri=DEFAULT_.opptjent, domain=None, range=Optional[Union[dict, Periode]])
...
slots.anviser = Slot(uri=ADM.anviser, name="anviser", curie=ADM.curie('anviser'),
                   model_uri=DEFAULT_.anviser, domain=None, range=Optional[Union[str, PersonalressursId]])

slots.konterer = Slot(uri=ADM.konterer, name="konterer", curie=ADM.curie('konterer'),
                   model_uri=DEFAULT_.konterer, domain=None, range=Optional[Union[str, PersonalressursId]])

slots.attestant = Slot(uri=ADM.attestant, name="attestant", curie=ADM.curie('attestant'),
                   model_uri=DEFAULT_.attestant, domain=None, range=Optional[Union[str, PersonalressursId]])
...
slots.rolleNavn = Slot(uri=ADM.rolleNavn, name="rolleNavn", curie=ADM.curie('rolleNavn'),
                   model_uri=DEFAULT_.rolleNavn, domain=None, range=Optional[Union[dict, Identifikator]])

slots.fullmakt = Slot(uri=ADM.fullmakt, name="fullmakt", curie=ADM.curie('fullmakt'),
                   model_uri=DEFAULT_.fullmakt, domain=None, range=Optional[Union[str, FullmaktId]])

slots.fullmektig = Slot(uri=ADM.fullmektig, name="fullmektig", curie=ADM.curie('fullmektig'),
                   model_uri=DEFAULT_.fullmektig, domain=None, range=Optional[Union[str, PersonalressursId]])

slots.stedfortreder = Slot(uri=ADM.stedfortreder, name="stedfortreder", curie=ADM.curie('stedfortreder'),
                   model_uri=DEFAULT_.stedfortreder, domain=None, range=Optional[str])
...
slots.personalressurskategori = Slot(uri=ADM.personalressurskategori, name="personalressurskategori", curie=ADM.curie('personalressurskategori'),
                   model_uri=DEFAULT_.personalressurskategori, domain=None, range=Optional[Union[str, PersonalressurskategoriId]])

slots.lederFor = Slot(uri=ADM.lederFor, name="lederFor", curie=ADM.curie('lederFor'),
                   model_uri=DEFAULT_.lederFor, domain=None, range=Optional[Union[Union[str, OrganisasjonselementId], list[Union[str, OrganisasjonselementId]]]])

slots.personalansvar = Slot(uri=ADM.personalansvar, name="personalansvar", curie=ADM.curie('personalansvar'),
                   model_uri=DEFAULT_.personalansvar, domain=None, range=Optional[Union[Union[str, ArbeidsforholdId], list[Union[str, ArbeidsforholdId]]]])

slots.skoleressurs = Slot(uri=ADM.skoleressurs, name="skoleressurs", curie=ADM.curie('skoleressurs'),
                   model_uri=DEFAULT_.skoleressurs, domain=None, range=Optional[Union[str, URIorCURIE]])

slots.ansettelsesprosent = Slot(uri=ADM.ansettelsesprosent, name="ansettelsesprosent", curie=ADM.curie('ansettelsesprosent'),
                   model_uri=DEFAULT_.ansettelsesprosent, domain=None, range=Optional[int])
...
slots.undervisningsforhold = Slot(uri=ADM.undervisningsforhold, name="undervisningsforhold", curie=ADM.curie('undervisningsforhold'),
                   model_uri=DEFAULT_.undervisningsforhold, domain=None, range=Optional[Union[str, URIorCURIE]])
...
slots.administrasjonContainer__personar = Slot(uri=DEFAULT_.personar, name="administrasjonContainer__personar", curie=DEFAULT_.curie('personar'),
                   model_uri=DEFAULT_.administrasjonContainer__personar, domain=None, range=Optional[Union[dict[Union[str, PersonId], Union[dict, Person]], list[Union[dict, Person]]]])

slots.administrasjonContainer__kontaktpersonar = Slot(uri=DEFAULT_.kontaktpersonar, name="administrasjonContainer__kontaktpersonar", curie=DEFAULT_.curie('kontaktpersonar'),
                   model_uri=DEFAULT_.administrasjonContainer__kontaktpersonar, domain=None, range=Optional[Union[dict[Union[str, KontaktpersonId], Union[dict, Kontaktperson]], list[Union[dict, Kontaktperson]]]])

slots.administrasjonContainer__virksomhetar = Slot(uri=DEFAULT_.virksomhetar, name="administrasjonContainer__virksomhetar", curie=DEFAULT_.curie('virksomhetar'),
                   model_uri=DEFAULT_.administrasjonContainer__virksomhetar, domain=None, range=Optional[Union[dict[Union[str, VirksomhetId], Union[dict, Virksomhet]], list[Union[dict, Virksomhet]]]])

slots.administrasjonContainer__landkodar = Slot(uri=DEFAULT_.landkodar, name="administrasjonContainer__landkodar", curie=DEFAULT_.curie('landkodar'),
                   model_uri=DEFAULT_.administrasjonContainer__landkodar, domain=None, range=Optional[Union[dict[Union[str, LandkodeId], Union[dict, Landkode]], list[Union[dict, Landkode]]]])

slots.administrasjonContainer__kjonn = Slot(uri=DEFAULT_.kjonn, name="administrasjonContainer__kjonn", curie=DEFAULT_.curie('kjonn'),
                   model_uri=DEFAULT_.administrasjonContainer__kjonn, domain=None, range=Optional[Union[dict[Union[str, KjonnId], Union[dict, Kjonn]], list[Union[dict, Kjonn]]]])

slots.administrasjonContainer__fylke = Slot(uri=DEFAULT_.fylke, name="administrasjonContainer__fylke", curie=DEFAULT_.curie('fylke'),
                   model_uri=DEFAULT_.administrasjonContainer__fylke, domain=None, range=Optional[Union[dict[Union[str, FylkeId], Union[dict, Fylke]], list[Union[dict, Fylke]]]])

slots.administrasjonContainer__kommunar = Slot(uri=DEFAULT_.kommunar, name="administrasjonContainer__kommunar", curie=DEFAULT_.curie('kommunar'),
                   model_uri=DEFAULT_.administrasjonContainer__kommunar, domain=None, range=Optional[Union[dict[Union[str, KommuneId], Union[dict, Kommune]], list[Union[dict, Kommune]]]])

slots.administrasjonContainer__spraak = Slot(uri=DEFAULT_.spraak, name="administrasjonContainer__spraak", curie=DEFAULT_.curie('spraak'),
                   model_uri=DEFAULT_.administrasjonContainer__spraak, domain=None, range=Optional[Union[dict[Union[str, SpraakId], Union[dict, Spraak]], list[Union[dict, Spraak]]]])

slots.administrasjonContainer__valuta = Slot(uri=DEFAULT_.valuta, name="administrasjonContainer__valuta", curie=DEFAULT_.curie('valuta'),
                   model_uri=DEFAULT_.administrasjonContainer__valuta, domain=None, range=Optional[Union[dict[Union[str, ValutaId], Union[dict, Valuta]], list[Union[dict, Valuta]]]])

slots.administrasjonContainer__personalressursar = Slot(uri=DEFAULT_.personalressursar, name="administrasjonContainer__personalressursar", curie=DEFAULT_.curie('personalressursar'),
                   model_uri=DEFAULT_.administrasjonContainer__personalressursar, domain=None, range=Optional[Union[dict[Union[str, PersonalressursId], Union[dict, Personalressurs]], list[Union[dict, Personalressurs]]]])

slots.administrasjonContainer__arbeidsforhold = Slot(uri=DEFAULT_.arbeidsforhold, name="administrasjonContainer__arbeidsforhold", curie=DEFAULT_.curie('arbeidsforhold'),
                   model_uri=DEFAULT_.administrasjonContainer__arbeidsforhold, domain=None, range=Optional[Union[dict[Union[str, ArbeidsforholdId], Union[dict, Arbeidsforhold]], list[Union[dict, Arbeidsforhold]]]])

slots.administrasjonContainer__arbeidslokasjoner = Slot(uri=DEFAULT_.arbeidslokasjoner, name="administrasjonContainer__arbeidslokasjoner", curie=DEFAULT_.curie('arbeidslokasjoner'),
                   model_uri=DEFAULT_.administrasjonContainer__arbeidslokasjoner, domain=None, range=Optional[Union[dict[Union[str, ArbeidslokasjonId], Union[dict, Arbeidslokasjon]], list[Union[dict, Arbeidslokasjon]]]])

slots.administrasjonContainer__fastlonn = Slot(uri=DEFAULT_.fastlonn, name="administrasjonContainer__fastlonn", curie=DEFAULT_.curie('fastlonn'),
                   model_uri=DEFAULT_.administrasjonContainer__fastlonn, domain=None, range=Optional[Union[dict[Union[str, FastlonnId], Union[dict, Fastlonn]], list[Union[dict, Fastlonn]]]])

slots.administrasjonContainer__fasttillegg = Slot(uri=DEFAULT_.fasttillegg, name="administrasjonContainer__fasttillegg", curie=DEFAULT_.curie('fasttillegg'),
                   model_uri=DEFAULT_.administrasjonContainer__fasttillegg, domain=None, range=Optional[Union[dict[Union[str, FasttilleggId], Union[dict, Fasttillegg]], list[Union[dict, Fasttillegg]]]])

slots.administrasjonContainer__fravaer = Slot(uri=DEFAULT_.fravaer, name="administrasjonContainer__fravaer", curie=DEFAULT_.curie('fravaer'),
                   model_uri=DEFAULT_.administrasjonContainer__fravaer, domain=None, range=Optional[Union[dict[Union[str, FravaerId], Union[dict, Fravaer]], list[Union[dict, Fravaer]]]])

slots.administrasjonContainer__fullmakter = Slot(uri=DEFAULT_.fullmakter, name="administrasjonContainer__fullmakter", curie=DEFAULT_.curie('fullmakter'),
                   model_uri=DEFAULT_.administrasjonContainer__fullmakter, domain=None, range=Optional[Union[dict[Union[str, FullmaktId], Union[dict, Fullmakt]], list[Union[dict, Fullmakt]]]])

slots.administrasjonContainer__organisasjonselement = Slot(uri=DEFAULT_.organisasjonselement, name="administrasjonContainer__organisasjonselement", curie=DEFAULT_.curie('organisasjonselement'),
                   model_uri=DEFAULT_.administrasjonContainer__organisasjonselement, domain=None, range=Optional[Union[dict[Union[str, OrganisasjonselementId], Union[dict, Organisasjonselement]], list[Union[dict, Organisasjonselement]]]])

slots.administrasjonContainer__rollar = Slot(uri=DEFAULT_.rollar, name="administrasjonContainer__rollar", curie=DEFAULT_.curie('rollar'),
                   model_uri=DEFAULT_.administrasjonContainer__rollar, domain=None, range=Optional[Union[dict[Union[str, RolleId], Union[dict, Rolle]], list[Union[dict, Rolle]]]])

slots.administrasjonContainer__variabellonn = Slot(uri=DEFAULT_.variabellonn, name="administrasjonContainer__variabellonn", curie=DEFAULT_.curie('variabellonn'),
                   model_uri=DEFAULT_.administrasjonContainer__variabellonn, domain=None, range=Optional[Union[dict[Union[str, VariabellonnId], Union[dict, Variabellonn]], list[Union[dict, Variabellonn]]]])

slots.administrasjonContainer__aktivitetar = Slot(uri=DEFAULT_.aktivitetar, name="administrasjonContainer__aktivitetar", curie=DEFAULT_.curie('aktivitetar'),
                   model_uri=DEFAULT_.administrasjonContainer__aktivitetar, domain=None, range=Optional[Union[dict[Union[str, AktivitetId], Union[dict, Aktivitet]], list[Union[dict, Aktivitet]]]])

slots.administrasjonContainer__anlegg = Slot(uri=DEFAULT_.anlegg, name="administrasjonContainer__anlegg", curie=DEFAULT_.curie('anlegg'),
                   model_uri=DEFAULT_.administrasjonContainer__anlegg, domain=None, range=Optional[Union[dict[Union[str, AnleggId], Union[dict, Anlegg]], list[Union[dict, Anlegg]]]])

slots.administrasjonContainer__ansvar = Slot(uri=DEFAULT_.ansvar, name="administrasjonContainer__ansvar", curie=DEFAULT_.curie('ansvar'),
                   model_uri=DEFAULT_.administrasjonContainer__ansvar, domain=None, range=Optional[Union[dict[Union[str, AnsvarId], Union[dict, Ansvar]], list[Union[dict, Ansvar]]]])

slots.administrasjonContainer__artar = Slot(uri=DEFAULT_.artar, name="administrasjonContainer__artar", curie=DEFAULT_.curie('artar'),
                   model_uri=DEFAULT_.administrasjonContainer__artar, domain=None, range=Optional[Union[dict[Union[str, ArtId], Union[dict, Art]], list[Union[dict, Art]]]])

slots.administrasjonContainer__arbeidsforholdstypar = Slot(uri=DEFAULT_.arbeidsforholdstypar, name="administrasjonContainer__arbeidsforholdstypar", curie=DEFAULT_.curie('arbeidsforholdstypar'),
                   model_uri=DEFAULT_.administrasjonContainer__arbeidsforholdstypar, domain=None, range=Optional[Union[dict[Union[str, ArbeidsforholdstypeId], Union[dict, Arbeidsforholdstype]], list[Union[dict, Arbeidsforholdstype]]]])

slots.administrasjonContainer__diverse = Slot(uri=DEFAULT_.diverse, name="administrasjonContainer__diverse", curie=DEFAULT_.curie('diverse'),
                   model_uri=DEFAULT_.administrasjonContainer__diverse, domain=None, range=Optional[Union[dict[Union[str, DiverseId], Union[dict, Diverse]], list[Union[dict, Diverse]]]])

slots.administrasjonContainer__formaal = Slot(uri=DEFAULT_.formaal, name="administrasjonContainer__formaal", curie=DEFAULT_.curie('formaal'),
                   model_uri=DEFAULT_.administrasjonContainer__formaal, domain=None, range=Optional[Union[dict[Union[str, FormaalId], Union[dict, Formaal]], list[Union[dict, Formaal]]]])

slots.administrasjonContainer__fravaersgrunnar = Slot(uri=DEFAULT_.fravaersgrunnar, name="administrasjonContainer__fravaersgrunnar", curie=DEFAULT_.curie('fravaersgrunnar'),
                   model_uri=DEFAULT_.administrasjonContainer__fravaersgrunnar, domain=None, range=Optional[Union[dict[Union[str, FravaersgrunnId], Union[dict, Fravaersgrunn]], list[Union[dict, Fravaersgrunn]]]])

slots.administrasjonContainer__fravaerstypar = Slot(uri=DEFAULT_.fravaerstypar, name="administrasjonContainer__fravaerstypar", curie=DEFAULT_.curie('fravaerstypar'),
                   model_uri=DEFAULT_.administrasjonContainer__fravaerstypar, domain=None, range=Optional[Union[dict[Union[str, FravaerstypeId], Union[dict, Fravaerstype]], list[Union[dict, Fravaerstype]]]])

slots.administrasjonContainer__funksjonar = Slot(uri=DEFAULT_.funksjonar, name="administrasjonContainer__funksjonar", curie=DEFAULT_.curie('funksjonar'),
                   model_uri=DEFAULT_.administrasjonContainer__funksjonar, domain=None, range=Optional[Union[dict[Union[str, FunksjonId], Union[dict, Funksjon]], list[Union[dict, Funksjon]]]])

slots.administrasjonContainer__kontrakter = Slot(uri=DEFAULT_.kontrakter, name="administrasjonContainer__kontrakter", curie=DEFAULT_.curie('kontrakter'),
                   model_uri=DEFAULT_.administrasjonContainer__kontrakter, domain=None, range=Optional[Union[dict[Union[str, KontraktId], Union[dict, Kontrakt]], list[Union[dict, Kontrakt]]]])

slots.administrasjonContainer__lonsartar = Slot(uri=DEFAULT_.lonsartar, name="administrasjonContainer__lonsartar", curie=DEFAULT_.curie('lonsartar'),
                   model_uri=DEFAULT_.administrasjonContainer__lonsartar, domain=None, range=Optional[Union[dict[Union[str, LonsartId], Union[dict, Lonsart]], list[Union[dict, Lonsart]]]])

slots.administrasjonContainer__lopenummer = Slot(uri=DEFAULT_.lopenummer, name="administrasjonContainer__lopenummer", curie=DEFAULT_.curie('lopenummer'),
                   model_uri=DEFAULT_.administrasjonContainer__lopenummer, domain=None, range=Optional[Union[dict[Union[str, LopenummerId], Union[dict, Lopenummer]], list[Union[dict, Lopenummer]]]])

slots.administrasjonContainer__objekt = Slot(uri=DEFAULT_.objekt, name="administrasjonContainer__objekt", curie=DEFAULT_.curie('objekt'),
                   model_uri=DEFAULT_.administrasjonContainer__objekt, domain=None, range=Optional[Union[dict[Union[str, ObjektId], Union[dict, Objekt]], list[Union[dict, Objekt]]]])

slots.administrasjonContainer__organisasjonstypar = Slot(uri=DEFAULT_.organisasjonstypar, name="administrasjonContainer__organisasjonstypar", curie=DEFAULT_.curie('organisasjonstypar'),
                   model_uri=DEFAULT_.administrasjonContainer__organisasjonstypar, domain=None, range=Optional[Union[dict[Union[str, OrganisasjonstypeId], Union[dict, Organisasjonstype]], list[Union[dict, Organisasjonstype]]]])

slots.administrasjonContainer__personalressurskategoriar = Slot(uri=DEFAULT_.personalressurskategoriar, name="administrasjonContainer__personalressurskategoriar", curie=DEFAULT_.curie('personalressurskategoriar'),
                   model_uri=DEFAULT_.administrasjonContainer__personalressurskategoriar, domain=None, range=Optional[Union[dict[Union[str, PersonalressurskategoriId], Union[dict, Personalressurskategori]], list[Union[dict, Personalressurskategori]]]])

slots.administrasjonContainer__prosjekt = Slot(uri=DEFAULT_.prosjekt, name="administrasjonContainer__prosjekt", curie=DEFAULT_.curie('prosjekt'),
                   model_uri=DEFAULT_.administrasjonContainer__prosjekt, domain=None, range=Optional[Union[dict[Union[str, ProsjektId], Union[dict, Prosjekt]], list[Union[dict, Prosjekt]]]])

slots.administrasjonContainer__prosjektartar = Slot(uri=DEFAULT_.prosjektartar, name="administrasjonContainer__prosjektartar", curie=DEFAULT_.curie('prosjektartar'),
                   model_uri=DEFAULT_.administrasjonContainer__prosjektartar, domain=None, range=Optional[Union[dict[Union[str, ProsjektartId], Union[dict, Prosjektart]], list[Union[dict, Prosjektart]]]])

slots.administrasjonContainer__rammer = Slot(uri=DEFAULT_.rammer, name="administrasjonContainer__rammer", curie=DEFAULT_.curie('rammer'),
                   model_uri=DEFAULT_.administrasjonContainer__rammer, domain=None, range=Optional[Union[dict[Union[str, RammeId], Union[dict, Ramme]], list[Union[dict, Ramme]]]])

slots.administrasjonContainer__stillingskoder = Slot(uri=DEFAULT_.stillingskoder, name="administrasjonContainer__stillingskoder", curie=DEFAULT_.curie('stillingskoder'),
                   model_uri=DEFAULT_.administrasjonContainer__stillingskoder, domain=None, range=Optional[Union[dict[Union[str, StillingskodeId], Union[dict, Stillingskode]], list[Union[dict, Stillingskode]]]])

slots.administrasjonContainer__uketimetall = Slot(uri=DEFAULT_.uketimetall, name="administrasjonContainer__uketimetall", curie=DEFAULT_.curie('uketimetall'),
                   model_uri=DEFAULT_.administrasjonContainer__uketimetall, domain=None, range=Optional[Union[dict[Union[str, UketimetallId], Union[dict, Uketimetall]], list[Union[dict, Uketimetall]]]])
...
slots.Ansvar_organisasjonselement = Slot(uri=ADM.organisasjonselement, name="Ansvar_organisasjonselement", curie=ADM.curie('organisasjonselement'),
                   model_uri=DEFAULT_.Ansvar_organisasjonselement, domain=Ansvar, range=Optional[Union[Union[str, OrganisasjonselementId], list[Union[str, OrganisasjonselementId]]]])

slots.Arbeidsforholdstype_forelder = Slot(uri=ADM.forelder, name="Arbeidsforholdstype_forelder", curie=ADM.curie('forelder'),
                   model_uri=DEFAULT_.Arbeidsforholdstype_forelder, domain=Arbeidsforholdstype, range=Optional[Union[str, ArbeidsforholdstypeId]])

slots.Fravaerstype_overfores = Slot(uri=ADM.overfores, name="Fravaerstype_overfores", curie=ADM.curie('overfores'),
                   model_uri=DEFAULT_.Fravaerstype_overfores, domain=Fravaerstype, range=Optional[Union[bool, Bool]])

slots.Fravaerstype_lonsart = Slot(uri=ADM.lonsart, name="Fravaerstype_lonsart", curie=ADM.curie('lonsart'),
                   model_uri=DEFAULT_.Fravaerstype_lonsart, domain=Fravaerstype, range=Optional[Union[str, LonsartId]])

slots.Funksjon_overordnet = Slot(uri=ADM.overordnet, name="Funksjon_overordnet", curie=ADM.curie('overordnet'),
                   model_uri=DEFAULT_.Funksjon_overordnet, domain=Funksjon, range=Optional[Union[str, FunksjonId]])

slots.Funksjon_underordnet = Slot(uri=ADM.underordnet, name="Funksjon_underordnet", curie=ADM.curie('underordnet'),
                   model_uri=DEFAULT_.Funksjon_underordnet, domain=Funksjon, range=Optional[Union[Union[str, FunksjonId], list[Union[str, FunksjonId]]]])

slots.Lonsart_kategori = Slot(uri=ADM.kategori, name="Lonsart_kategori", curie=ADM.curie('kategori'),
                   model_uri=DEFAULT_.Lonsart_kategori, domain=Lonsart, range=Optional[str])

slots.Lonsart_art = Slot(uri=ADM.art, name="Lonsart_art", curie=ADM.curie('art'),
                   model_uri=DEFAULT_.Lonsart_art, domain=Lonsart, range=Optional[Union[str, ArtId]])

slots.Prosjekt_prosjektart = Slot(uri=ADM.prosjektart, name="Prosjekt_prosjektart", curie=ADM.curie('prosjektart'),
                   model_uri=DEFAULT_.Prosjekt_prosjektart, domain=Prosjekt, range=Optional[Union[Union[str, ProsjektartId], list[Union[str, ProsjektartId]]]])

slots.Prosjektart_prosjekt = Slot(uri=ADM.prosjekt, name="Prosjektart_prosjekt", curie=ADM.curie('prosjekt'),
                   model_uri=DEFAULT_.Prosjektart_prosjekt, domain=Prosjektart, range=Optional[Union[str, ProsjektId]])

slots.Prosjektart_overordnet = Slot(uri=ADM.overordnet, name="Prosjektart_overordnet", curie=ADM.curie('overordnet'),
                   model_uri=DEFAULT_.Prosjektart_overordnet, domain=Prosjektart, range=Optional[Union[str, ProsjektartId]])

slots.Prosjektart_underordnet = Slot(uri=ADM.underordnet, name="Prosjektart_underordnet", curie=ADM.curie('underordnet'),
                   model_uri=DEFAULT_.Prosjektart_underordnet, domain=Prosjektart, range=Optional[Union[Union[str, ProsjektartId], list[Union[str, ProsjektartId]]]])

slots.Stillingskode_forelder = Slot(uri=ADM.forelder, name="Stillingskode_forelder", curie=ADM.curie('forelder'),
                   model_uri=DEFAULT_.Stillingskode_forelder, domain=Stillingskode, range=Optional[Union[str, StillingskodeId]])

slots.Fastlonn_prosent = Slot(uri=ADM.prosent, name="Fastlonn_prosent", curie=ADM.curie('prosent'),
                   model_uri=DEFAULT_.Fastlonn_prosent, domain=Fastlonn, range=int)

slots.Fastlonn_arbeidsforhold = Slot(uri=ADM.arbeidsforhold, name="Fastlonn_arbeidsforhold", curie=ADM.curie('arbeidsforhold'),
                   model_uri=DEFAULT_.Fastlonn_arbeidsforhold, domain=Fastlonn, range=Union[str, ArbeidsforholdId])

slots.Fastlonn_lonsart = Slot(uri=ADM.lonsart, name="Fastlonn_lonsart", curie=ADM.curie('lonsart'),
                   model_uri=DEFAULT_.Fastlonn_lonsart, domain=Fastlonn, range=Optional[Union[str, LonsartId]])

slots.Fasttillegg_belop = Slot(uri=ADM.belop, name="Fasttillegg_belop", curie=ADM.curie('belop'),
                   model_uri=DEFAULT_.Fasttillegg_belop, domain=Fasttillegg, range=int)

slots.Fasttillegg_lonsart = Slot(uri=ADM.lonsart, name="Fasttillegg_lonsart", curie=ADM.curie('lonsart'),
                   model_uri=DEFAULT_.Fasttillegg_lonsart, domain=Fasttillegg, range=Union[str, LonsartId])
...
slots.Fasttillegg_arbeidsforhold = Slot(uri=ADM.arbeidsforhold, name="Fasttillegg_arbeidsforhold", curie=ADM.curie('arbeidsforhold'),
                   model_uri=DEFAULT_.Fasttillegg_arbeidsforhold, domain=Fasttillegg, range=Union[str, ArbeidsforholdId])

slots.Variabellonn_antall = Slot(uri=ADM.antall, name="Variabellonn_antall", curie=ADM.curie('antall'),
                   model_uri=DEFAULT_.Variabellonn_antall, domain=Variabellonn, range=int)

slots.Variabellonn_lonsart = Slot(uri=ADM.lonsart, name="Variabellonn_lonsart", curie=ADM.curie('lonsart'),
                   model_uri=DEFAULT_.Variabellonn_lonsart, domain=Variabellonn, range=Union[str, LonsartId])
...
slots.Fullmakt_gyldighetsperiode = Slot(uri=FINT.gyldighetsperiode, name="Fullmakt_gyldighetsperiode", curie=FINT.curie('gyldighetsperiode'),
                   model_uri=DEFAULT_.Fullmakt_gyldighetsperiode, domain=Fullmakt, range=Union[dict, "Periode"])

slots.Fullmakt_rolle = Slot(uri=ADM.rolle, name="Fullmakt_rolle", curie=ADM.curie('rolle'),
                   model_uri=DEFAULT_.Fullmakt_rolle, domain=Fullmakt, range=Union[str, RolleId])

slots.Fullmakt_ramme = Slot(uri=ADM.ramme, name="Fullmakt_ramme", curie=ADM.curie('ramme'),
                   model_uri=DEFAULT_.Fullmakt_ramme, domain=Fullmakt, range=Optional[Union[str, RammeId]])

slots.Fullmakt_funksjon = Slot(uri=ADM.funksjon, name="Fullmakt_funksjon", curie=ADM.curie('funksjon'),
                   model_uri=DEFAULT_.Fullmakt_funksjon, domain=Fullmakt, range=Optional[Union[str, FunksjonId]])

slots.Fullmakt_objekt = Slot(uri=ADM.objekt, name="Fullmakt_objekt", curie=ADM.curie('objekt'),
                   model_uri=DEFAULT_.Fullmakt_objekt, domain=Fullmakt, range=Optional[Union[str, ObjektId]])
...
slots.Fullmakt_organisasjonselement = Slot(uri=ADM.organisasjonselement, name="Fullmakt_organisasjonselement", curie=ADM.curie('organisasjonselement'),
                   model_uri=DEFAULT_.Fullmakt_organisasjonselement, domain=Fullmakt, range=Optional[Union[str, OrganisasjonselementId]])

slots.Fullmakt_art = Slot(uri=ADM.art, name="Fullmakt_art", curie=ADM.curie('art'),
                   model_uri=DEFAULT_.Fullmakt_art, domain=Fullmakt, range=Optional[Union[str, ArtId]])

slots.Fullmakt_anlegg = Slot(uri=ADM.anlegg, name="Fullmakt_anlegg", curie=ADM.curie('anlegg'),
                   model_uri=DEFAULT_.Fullmakt_anlegg, domain=Fullmakt, range=Optional[Union[str, AnleggId]])

slots.Fullmakt_diverse = Slot(uri=ADM.diverse, name="Fullmakt_diverse", curie=ADM.curie('diverse'),
                   model_uri=DEFAULT_.Fullmakt_diverse, domain=Fullmakt, range=Optional[Union[str, DiverseId]])

slots.Fullmakt_aktivitet = Slot(uri=ADM.aktivitet, name="Fullmakt_aktivitet", curie=ADM.curie('aktivitet'),
                   model_uri=DEFAULT_.Fullmakt_aktivitet, domain=Fullmakt, range=Optional[Union[str, AktivitetId]])

slots.Fullmakt_ansvar = Slot(uri=ADM.ansvar, name="Fullmakt_ansvar", curie=ADM.curie('ansvar'),
                   model_uri=DEFAULT_.Fullmakt_ansvar, domain=Fullmakt, range=Optional[Union[str, AnsvarId]])

slots.Fullmakt_stedfortreder = Slot(uri=ADM.stedfortreder, name="Fullmakt_stedfortreder", curie=ADM.curie('stedfortreder'),
                   model_uri=DEFAULT_.Fullmakt_stedfortreder, domain=Fullmakt, range=Optional[Union[str, PersonalressursId]])

slots.Fullmakt_kontrakt = Slot(uri=ADM.kontrakt, name="Fullmakt_kontrakt", curie=ADM.curie('kontrakt'),
                   model_uri=DEFAULT_.Fullmakt_kontrakt, domain=Fullmakt, range=Optional[Union[str, KontraktId]])

slots.Fullmakt_fullmektig = Slot(uri=ADM.fullmektig, name="Fullmakt_fullmektig", curie=ADM.curie('fullmektig'),
                   model_uri=DEFAULT_.Fullmakt_fullmektig, domain=Fullmakt, range=Optional[Union[str, PersonalressursId]])

slots.Fullmakt_prosjekt = Slot(uri=ADM.prosjekt, name="Fullmakt_prosjekt", curie=ADM.curie('prosjekt'),
                   model_uri=DEFAULT_.Fullmakt_prosjekt, domain=Fullmakt, range=Optional[Union[str, ProsjektId]])

slots.Fullmakt_formaal = Slot(uri=ADM.formaal, name="Fullmakt_formaal", curie=ADM.curie('formaal'),
                   model_uri=DEFAULT_.Fullmakt_formaal, domain=Fullmakt, range=Optional[Union[str, FormaalId]])

slots.Fullmakt_lopenummer = Slot(uri=ADM.lopenummer, name="Fullmakt_lopenummer", curie=ADM.curie('lopenummer'),
                   model_uri=DEFAULT_.Fullmakt_lopenummer, domain=Fullmakt, range=Optional[Union[str, LopenummerId]])

slots.Rolle_rolleNavn = Slot(uri=ADM.rolleNavn, name="Rolle_rolleNavn", curie=ADM.curie('rolleNavn'),
                   model_uri=DEFAULT_.Rolle_rolleNavn, domain=Rolle, range=Union[dict, "Identifikator"])

slots.Rolle_beskrivelse = Slot(uri=FINT.beskrivelse, name="Rolle_beskrivelse", curie=FINT.curie('beskrivelse'),
                   model_uri=DEFAULT_.Rolle_beskrivelse, domain=Rolle, range=str)

slots.Rolle_fullmakt = Slot(uri=ADM.fullmakt, name="Rolle_fullmakt", curie=ADM.curie('fullmakt'),
                   model_uri=DEFAULT_.Rolle_fullmakt, domain=Rolle, range=Union[Union[str, FullmaktId], list[Union[str, FullmaktId]]])
...
slots.Arbeidslokasjon_lokasjonskode = Slot(uri=ADM.lokasjonskode, name="Arbeidslokasjon_lokasjonskode", curie=ADM.curie('lokasjonskode'),
                   model_uri=DEFAULT_.Arbeidslokasjon_lokasjonskode, domain=Arbeidslokasjon, range=Union[dict, "Identifikator"])
...
slots.Arbeidslokasjon_lokasjonsnavn = Slot(uri=ADM.lokasjonsnavn, name="Arbeidslokasjon_lokasjonsnavn", curie=ADM.curie('lokasjonsnavn'),
                   model_uri=DEFAULT_.Arbeidslokasjon_lokasjonsnavn, domain=Arbeidslokasjon, range=Optional[str])
...
slots.Arbeidslokasjon_forretningsadresse = Slot(uri=FINT.forretningsadresse, name="Arbeidslokasjon_forretningsadresse", curie=FINT.curie('forretningsadresse'),
                   model_uri=DEFAULT_.Arbeidslokasjon_forretningsadresse, domain=Arbeidslokasjon, range=Optional[Union[dict, "Adresse"]])
...
slots.Arbeidslokasjon_organisasjonsnavn = Slot(uri=FINT.organisasjonsnavn, name="Arbeidslokasjon_organisasjonsnavn", curie=FINT.curie('organisasjonsnavn'),
                   model_uri=DEFAULT_.Arbeidslokasjon_organisasjonsnavn, domain=Arbeidslokasjon, range=Optional[str])
...
slots.Arbeidslokasjon_organisasjonsnummer = Slot(uri=FINT.organisasjonsnummer, name="Arbeidslokasjon_organisasjonsnummer", curie=FINT.curie('organisasjonsnummer'),
                   model_uri=DEFAULT_.Arbeidslokasjon_organisasjonsnummer, domain=Arbeidslokasjon, range=Optional[Union[dict, "Identifikator"]])
...
slots.Arbeidslokasjon_kontaktinformasjon = Slot(uri=FINT.kontaktinformasjon, name="Arbeidslokasjon_kontaktinformasjon", curie=FINT.curie('kontaktinformasjon'),
                   model_uri=DEFAULT_.Arbeidslokasjon_kontaktinformasjon, domain=Arbeidslokasjon, range=Optional[Union[dict, "Kontaktinformasjon"]])
...
slots.Arbeidslokasjon_postadresse = Slot(uri=FINT.postadresse, name="Arbeidslokasjon_postadresse", curie=FINT.curie('postadresse'),
                   model_uri=DEFAULT_.Arbeidslokasjon_postadresse, domain=Arbeidslokasjon, range=Optional[Union[dict, "Adresse"]])
...
slots.Arbeidslokasjon_arbeidsforhold = Slot(uri=ADM.arbeidsforhold, name="Arbeidslokasjon_arbeidsforhold", curie=ADM.curie('arbeidsforhold'),
                   model_uri=DEFAULT_.Arbeidslokasjon_arbeidsforhold, domain=Arbeidslokasjon, range=Optional[Union[Union[str, ArbeidsforholdId], list[Union[str, ArbeidsforholdId]]]])
...
slots.Organisasjonselement_organisasjonsId = Slot(uri=ADM.organisasjonsId, name="Organisasjonselement_organisasjonsId", curie=ADM.curie('organisasjonsId'),
                   model_uri=DEFAULT_.Organisasjonselement_organisasjonsId, domain=Organisasjonselement, range=Union[dict, "Identifikator"])
...
slots.Organisasjonselement_organisasjonsKode = Slot(uri=ADM.organisasjonsKode, name="Organisasjonselement_organisasjonsKode", curie=ADM.curie('organisasjonsKode'),
                   model_uri=DEFAULT_.Organisasjonselement_organisasjonsKode, domain=Organisasjonselement, range=Union[dict, "Identifikator"])
...
slots.Organisasjonselement_overordnet = Slot(uri=ADM.overordnet, name="Organisasjonselement_overordnet", curie=ADM.curie('overordnet'),
                   model_uri=DEFAULT_.Organisasjonselement_overordnet, domain=Organisasjonselement, range=Union[str, OrganisasjonselementId])
...
slots.Organisasjonselement_gyldighetsperiode = Slot(uri=FINT.gyldighetsperiode, name="Organisasjonselement_gyldighetsperiode", curie=FINT.curie('gyldighetsperiode'),
                   model_uri=DEFAULT_.Organisasjonselement_gyldighetsperiode, domain=Organisasjonselement, range=Optional[Union[dict, "Periode"]])

slots.Organisasjonselement_kortnavn = Slot(uri=ADM.kortnavn, name="Organisasjonselement_kortnavn", curie=ADM.curie('kortnavn'),
                   model_uri=DEFAULT_.Organisasjonselement_kortnavn, domain=Organisasjonselement, range=Optional[str])

slots.Organisasjonselement_navn = Slot(uri=FINT.navn, name="Organisasjonselement_navn", curie=FINT.curie('navn'),
                   model_uri=DEFAULT_.Organisasjonselement_navn, domain=Organisasjonselement, range=Optional[str])
...
slots.Organisasjonselement_forretningsadresse = Slot(uri=FINT.forretningsadresse, name="Organisasjonselement_forretningsadresse", curie=FINT.curie('forretningsadresse'),
                   model_uri=DEFAULT_.Organisasjonselement_forretningsadresse, domain=Organisasjonselement, range=Optional[Union[dict, "Adresse"]])
...
slots.Organisasjonselement_organisasjonsnavn = Slot(uri=FINT.organisasjonsnavn, name="Organisasjonselement_organisasjonsnavn", curie=FINT.curie('organisasjonsnavn'),
                   model_uri=DEFAULT_.Organisasjonselement_organisasjonsnavn, domain=Organisasjonselement, range=Optional[str])
...
slots.Organisasjonselement_organisasjonsnummer = Slot(uri=FINT.organisasjonsnummer, name="Organisasjonselement_organisasjonsnummer", curie=FINT.curie('organisasjonsnummer'),
                   model_uri=DEFAULT_.Organisasjonselement_organisasjonsnummer, domain=Organisasjonselement, range=Optional[Union[dict, "Identifikator"]])
...
slots.Organisasjonselement_kontaktinformasjon = Slot(uri=FINT.kontaktinformasjon, name="Organisasjonselement_kontaktinformasjon", curie=FINT.curie('kontaktinformasjon'),
                   model_uri=DEFAULT_.Organisasjonselement_kontaktinformasjon, domain=Organisasjonselement, range=Optional[Union[dict, "Kontaktinformasjon"]])
...
slots.Organisasjonselement_postadresse = Slot(uri=FINT.postadresse, name="Organisasjonselement_postadresse", curie=FINT.curie('postadresse'),
                   model_uri=DEFAULT_.Organisasjonselement_postadresse, domain=Organisasjonselement, range=Optional[Union[dict, "Adresse"]])

slots.Organisasjonselement_ansvar = Slot(uri=ADM.ansvar, name="Organisasjonselement_ansvar", curie=ADM.curie('ansvar'),
                   model_uri=DEFAULT_.Organisasjonselement_ansvar, domain=Organisasjonselement, range=Optional[Union[Union[str, AnsvarId], list[Union[str, AnsvarId]]]])
...
slots.Organisasjonselement_organisasjonstype = Slot(uri=ADM.organisasjonstype, name="Organisasjonselement_organisasjonstype", curie=ADM.curie('organisasjonstype'),
                   model_uri=DEFAULT_.Organisasjonselement_organisasjonstype, domain=Organisasjonselement, range=Optional[Union[str, OrganisasjonstypeId]])

slots.Organisasjonselement_leder = Slot(uri=ADM.leder, name="Organisasjonselement_leder", curie=ADM.curie('leder'),
                   model_uri=DEFAULT_.Organisasjonselement_leder, domain=Organisasjonselement, range=Optional[Union[str, PersonalressursId]])
...
slots.Organisasjonselement_underordnet = Slot(uri=ADM.underordnet, name="Organisasjonselement_underordnet", curie=ADM.curie('underordnet'),
                   model_uri=DEFAULT_.Organisasjonselement_underordnet, domain=Organisasjonselement, range=Optional[Union[Union[str, OrganisasjonselementId], list[Union[str, OrganisasjonselementId]]]])

slots.Organisasjonselement_skole = Slot(uri=ADM.skole, name="Organisasjonselement_skole", curie=ADM.curie('skole'),
                   model_uri=DEFAULT_.Organisasjonselement_skole, domain=Organisasjonselement, range=Optional[Union[str, URIorCURIE]])
...
slots.Organisasjonselement_arbeidsforhold = Slot(uri=ADM.arbeidsforhold, name="Organisasjonselement_arbeidsforhold", curie=ADM.curie('arbeidsforhold'),
                   model_uri=DEFAULT_.Organisasjonselement_arbeidsforhold, domain=Organisasjonselement, range=Optional[Union[Union[str, ArbeidsforholdId], list[Union[str, ArbeidsforholdId]]]])
...
slots.Personalressurs_ansattnummer = Slot(uri=ADM.ansattnummer, name="Personalressurs_ansattnummer", curie=ADM.curie('ansattnummer'),
                   model_uri=DEFAULT_.Personalressurs_ansattnummer, domain=Personalressurs, range=Union[dict, "Identifikator"])
...
slots.Personalressurs_ansettelsesperiode = Slot(uri=ADM.ansettelsesperiode, name="Personalressurs_ansettelsesperiode", curie=ADM.curie('ansettelsesperiode'),
                   model_uri=DEFAULT_.Personalressurs_ansettelsesperiode, domain=Personalressurs, range=Union[dict, "Periode"])

slots.Personalressurs_person = Slot(uri=FINT.person, name="Personalressurs_person", curie=FINT.curie('person'),
                   model_uri=DEFAULT_.Personalressurs_person, domain=Personalressurs, range=Union[str, PersonId])
...
slots.Personalressurs_personalressurskategori = Slot(uri=ADM.personalressurskategori, name="Personalressurs_personalressurskategori", curie=ADM.curie('personalressurskategori'),
                   model_uri=DEFAULT_.Personalressurs_personalressurskategori, domain=Personalressurs, range=Union[str, PersonalressurskategoriId])

slots.Personalressurs_ansiennitet = Slot(uri=ADM.ansiennitet, name="Personalressurs_ansiennitet", curie=ADM.curie('ansiennitet'),
                   model_uri=DEFAULT_.Personalressurs_ansiennitet, domain=Personalressurs, range=Optional[Union[str, XSDDate]])

slots.Personalressurs_brukernavn = Slot(uri=ADM.brukernavn, name="Personalressurs_brukernavn", curie=ADM.curie('brukernavn'),
                   model_uri=DEFAULT_.Personalressurs_brukernavn, domain=Personalressurs, range=Optional[Union[dict, "Identifikator"]])

slots.Personalressurs_jobbtittel = Slot(uri=ADM.jobbtittel, name="Personalressurs_jobbtittel", curie=ADM.curie('jobbtittel'),
                   model_uri=DEFAULT_.Personalressurs_jobbtittel, domain=Personalressurs, range=Optional[str])
...
slots.Personalressurs_kontaktinformasjon = Slot(uri=FINT.kontaktinformasjon, name="Personalressurs_kontaktinformasjon", curie=FINT.curie('kontaktinformasjon'),
                   model_uri=DEFAULT_.Personalressurs_kontaktinformasjon, domain=Personalressurs, range=Optional[Union[dict, "Kontaktinformasjon"]])
...
slots.Personalressurs_stedfortreder = Slot(uri=ADM.stedfortreder, name="Personalressurs_stedfortreder", curie=ADM.curie('stedfortreder'),
                   model_uri=DEFAULT_.Personalressurs_stedfortreder, domain=Personalressurs, range=Optional[Union[Union[str, FullmaktId], list[Union[str, FullmaktId]]]])

slots.Personalressurs_fullmakt = Slot(uri=ADM.fullmakt, name="Personalressurs_fullmakt", curie=ADM.curie('fullmakt'),
                   model_uri=DEFAULT_.Personalressurs_fullmakt, domain=Personalressurs, range=Optional[Union[Union[str, FullmaktId], list[Union[str, FullmaktId]]]])

slots.Personalressurs_lederFor = Slot(uri=ADM.lederFor, name="Personalressurs_lederFor", curie=ADM.curie('lederFor'),
                   model_uri=DEFAULT_.Personalressurs_lederFor, domain=Personalressurs, range=Optional[Union[Union[str, OrganisasjonselementId], list[Union[str, OrganisasjonselementId]]]])
...
slots.Personalressurs_arbeidsforhold = Slot(uri=ADM.arbeidsforhold, name="Personalressurs_arbeidsforhold", curie=ADM.curie('arbeidsforhold'),
                   model_uri=DEFAULT_.Personalressurs_arbeidsforhold, domain=Personalressurs, range=Optional[Union[Union[str, ArbeidsforholdId], list[Union[str, ArbeidsforholdId]]]])
...
slots.Personalressurs_personalansvar = Slot(uri=ADM.personalansvar, name="Personalressurs_personalansvar", curie=ADM.curie('personalansvar'),
                   model_uri=DEFAULT_.Personalressurs_personalansvar, domain=Personalressurs, range=Optional[Union[Union[str, ArbeidsforholdId], list[Union[str, ArbeidsforholdId]]]])
...
slots.Personalressurs_skoleressurs = Slot(uri=ADM.skoleressurs, name="Personalressurs_skoleressurs", curie=ADM.curie('skoleressurs'),
                   model_uri=DEFAULT_.Personalressurs_skoleressurs, domain=Personalressurs, range=Optional[Union[str, URIorCURIE]])
...
slots.Arbeidsforhold_ansettelsesprosent = Slot(uri=ADM.ansettelsesprosent, name="Arbeidsforhold_ansettelsesprosent", curie=ADM.curie('ansettelsesprosent'),
                   model_uri=DEFAULT_.Arbeidsforhold_ansettelsesprosent, domain=Arbeidsforhold, range=int)

slots.Arbeidsforhold_aarslonn = Slot(uri=ADM.aarslonn, name="Arbeidsforhold_aarslonn", curie=ADM.curie('aarslonn'),
                   model_uri=DEFAULT_.Arbeidsforhold_aarslonn, domain=Arbeidsforhold, range=int)
...
slots.Arbeidsforhold_gyldighetsperiode = Slot(uri=FINT.gyldighetsperiode, name="Arbeidsforhold_gyldighetsperiode", curie=FINT.curie('gyldighetsperiode'),
                   model_uri=DEFAULT_.Arbeidsforhold_gyldighetsperiode, domain=Arbeidsforhold, range=Union[dict, "Periode"])
...
slots.Arbeidsforhold_hovedstilling = Slot(uri=ADM.hovedstilling, name="Arbeidsforhold_hovedstilling", curie=ADM.curie('hovedstilling'),
                   model_uri=DEFAULT_.Arbeidsforhold_hovedstilling, domain=Arbeidsforhold, range=Union[bool, Bool])
...
slots.Arbeidsforhold_lonnsprosent = Slot(uri=ADM.lonnsprosent, name="Arbeidsforhold_lonnsprosent", curie=ADM.curie('lonnsprosent'),
                   model_uri=DEFAULT_.Arbeidsforhold_lonnsprosent, domain=Arbeidsforhold, range=int)
...
slots.Arbeidsforhold_stillingsnummer = Slot(uri=ADM.stillingsnummer, name="Arbeidsforhold_stillingsnummer", curie=ADM.curie('stillingsnummer'),
                   model_uri=DEFAULT_.Arbeidsforhold_stillingsnummer, domain=Arbeidsforhold, range=str)
...
slots.Arbeidsforhold_tilstedeprosent = Slot(uri=ADM.tilstedeprosent, name="Arbeidsforhold_tilstedeprosent", curie=ADM.curie('tilstedeprosent'),
                   model_uri=DEFAULT_.Arbeidsforhold_tilstedeprosent, domain=Arbeidsforhold, range=int)

slots.Arbeidsforhold_arbeidssted = Slot(uri=ADM.arbeidssted, name="Arbeidsforhold_arbeidssted", curie=ADM.curie('arbeidssted'),
                   model_uri=DEFAULT_.Arbeidsforhold_arbeidssted, domain=Arbeidsforhold, range=Union[str, OrganisasjonselementId])
...
slots.Arbeidsforhold_personalressurs = Slot(uri=ADM.personalressurs, name="Arbeidsforhold_personalressurs", curie=ADM.curie('personalressurs'),
                   model_uri=DEFAULT_.Arbeidsforhold_personalressurs, domain=Arbeidsforhold, range=Union[str, PersonalressursId])
...
slots.Arbeidsforhold_arbeidsforholdsperiode = Slot(uri=ADM.arbeidsforholdsperiode, name="Arbeidsforhold_arbeidsforholdsperiode", curie=ADM.curie('arbeidsforholdsperiode'),
                   model_uri=DEFAULT_.Arbeidsforhold_arbeidsforholdsperiode, domain=Arbeidsforhold, range=Optional[Union[dict, "Periode"]])
...
slots.Arbeidsforhold_stillingstittel = Slot(uri=ADM.stillingstittel, name="Arbeidsforhold_stillingstittel", curie=ADM.curie('stillingstittel'),
                   model_uri=DEFAULT_.Arbeidsforhold_stillingstittel, domain=Arbeidsforhold, range=Optional[str])

slots.Arbeidsforhold_aktivitet = Slot(uri=ADM.aktivitet, name="Arbeidsforhold_aktivitet", curie=ADM.curie('aktivitet'),
                   model_uri=DEFAULT_.Arbeidsforhold_aktivitet, domain=Arbeidsforhold, range=Optional[Union[str, AktivitetId]])

slots.Arbeidsforhold_anlegg = Slot(uri=ADM.anlegg, name="Arbeidsforhold_anlegg", curie=ADM.curie('anlegg'),
                   model_uri=DEFAULT_.Arbeidsforhold_anlegg, domain=Arbeidsforhold, range=Optional[Union[str, AnleggId]])

slots.Arbeidsforhold_ansvar = Slot(uri=ADM.ansvar, name="Arbeidsforhold_ansvar", curie=ADM.curie('ansvar'),
                   model_uri=DEFAULT_.Arbeidsforhold_ansvar, domain=Arbeidsforhold, range=Optional[Union[str, AnsvarId]])
...
slots.Arbeidsforhold_arbeidsforholdstype = Slot(uri=ADM.arbeidsforholdstype, name="Arbeidsforhold_arbeidsforholdstype", curie=ADM.curie('arbeidsforholdstype'),
                   model_uri=DEFAULT_.Arbeidsforhold_arbeidsforholdstype, domain=Arbeidsforhold, range=Optional[Union[str, ArbeidsforholdstypeId]])

slots.Arbeidsforhold_art = Slot(uri=ADM.art, name="Arbeidsforhold_art", curie=ADM.curie('art'),
                   model_uri=DEFAULT_.Arbeidsforhold_art, domain=Arbeidsforhold, range=Optional[Union[str, ArtId]])

slots.Arbeidsforhold_diverse = Slot(uri=ADM.diverse, name="Arbeidsforhold_diverse", curie=ADM.curie('diverse'),
                   model_uri=DEFAULT_.Arbeidsforhold_diverse, domain=Arbeidsforhold, range=Optional[Union[str, DiverseId]])

slots.Arbeidsforhold_formaal = Slot(uri=ADM.formaal, name="Arbeidsforhold_formaal", curie=ADM.curie('formaal'),
                   model_uri=DEFAULT_.Arbeidsforhold_formaal, domain=Arbeidsforhold, range=Optional[Union[str, FormaalId]])

slots.Arbeidsforhold_funksjon = Slot(uri=ADM.funksjon, name="Arbeidsforhold_funksjon", curie=ADM.curie('funksjon'),
                   model_uri=DEFAULT_.Arbeidsforhold_funksjon, domain=Arbeidsforhold, range=Optional[Union[str, FunksjonId]])

slots.Arbeidsforhold_kontrakt = Slot(uri=ADM.kontrakt, name="Arbeidsforhold_kontrakt", curie=ADM.curie('kontrakt'),
                   model_uri=DEFAULT_.Arbeidsforhold_kontrakt, domain=Arbeidsforhold, range=Optional[Union[str, KontraktId]])

slots.Arbeidsforhold_lopenummer = Slot(uri=ADM.lopenummer, name="Arbeidsforhold_lopenummer", curie=ADM.curie('lopenummer'),
                   model_uri=DEFAULT_.Arbeidsforhold_lopenummer, domain=Arbeidsforhold, range=Optional[Union[str, LopenummerId]])

slots.Arbeidsforhold_objekt = Slot(uri=ADM.objekt, name="Arbeidsforhold_objekt", curie=ADM.curie('objekt'),
                   model_uri=DEFAULT_.Arbeidsforhold_objekt, domain=Arbeidsforhold, range=Optional[Union[str, ObjektId]])

slots.Arbeidsforhold_prosjekt = Slot(uri=ADM.prosjekt, name="Arbeidsforhold_prosjekt", curie=ADM.curie('prosjekt'),
                   model_uri=DEFAULT_.Arbeidsforhold_prosjekt, domain=Arbeidsforhold, range=Optional[Union[str, ProsjektId]])

slots.Arbeidsforhold_ramme = Slot(uri=ADM.ramme, name="Arbeidsforhold_ramme", curie=ADM.curie('ramme'),
                   model_uri=DEFAULT_.Arbeidsforhold_ramme, domain=Arbeidsforhold, range=Optional[Union[str, RammeId]])
...
slots.Arbeidsforhold_stillingskode = Slot(uri=ADM.stillingskode, name="Arbeidsforhold_stillingskode", curie=ADM.curie('stillingskode'),
                   model_uri=DEFAULT_.Arbeidsforhold_stillingskode, domain=Arbeidsforhold, range=Optional[Union[str, StillingskodeId]])

slots.Arbeidsforhold_timerPerUke = Slot(uri=ADM.timerPerUke, name="Arbeidsforhold_timerPerUke", curie=ADM.curie('timerPerUke'),
                   model_uri=DEFAULT_.Arbeidsforhold_timerPerUke, domain=Arbeidsforhold, range=Optional[Union[str, UketimetallId]])
...
slots.Arbeidsforhold_arbeidslokasjon = Slot(uri=ADM.arbeidslokasjon, name="Arbeidsforhold_arbeidslokasjon", curie=ADM.curie('arbeidslokasjon'),
                   model_uri=DEFAULT_.Arbeidsforhold_arbeidslokasjon, domain=Arbeidsforhold, range=Optional[Union[str, ArbeidslokasjonId]])

slots.Arbeidsforhold_fastlonn = Slot(uri=ADM.fastlonn, name="Arbeidsforhold_fastlonn", curie=ADM.curie('fastlonn'),
                   model_uri=DEFAULT_.Arbeidsforhold_fastlonn, domain=Arbeidsforhold, range=Optional[Union[Union[str, FastlonnId], list[Union[str, FastlonnId]]]])

slots.Arbeidsforhold_fasttillegg = Slot(uri=ADM.fasttillegg, name="Arbeidsforhold_fasttillegg", curie=ADM.curie('fasttillegg'),
                   model_uri=DEFAULT_.Arbeidsforhold_fasttillegg, domain=Arbeidsforhold, range=Optional[Union[Union[str, FasttilleggId], list[Union[str, FasttilleggId]]]])

slots.Arbeidsforhold_fravaer = Slot(uri=ADM.fravaer, name="Arbeidsforhold_fravaer", curie=ADM.curie('fravaer'),
                   model_uri=DEFAULT_.Arbeidsforhold_fravaer, domain=Arbeidsforhold, range=Optional[Union[Union[str, FravaerId], list[Union[str, FravaerId]]]])
...
slots.Arbeidsforhold_variabellonn = Slot(uri=ADM.variabellonn, name="Arbeidsforhold_variabellonn", curie=ADM.curie('variabellonn'),
                   model_uri=DEFAULT_.Arbeidsforhold_variabellonn, domain=Arbeidsforhold, range=Optional[Union[Union[str, VariabellonnId], list[Union[str, VariabellonnId]]]])
...
slots.Arbeidsforhold_personalleder = Slot(uri=ADM.personalleder, name="Arbeidsforhold_personalleder", curie=ADM.curie('personalleder'),
                   model_uri=DEFAULT_.Arbeidsforhold_personalleder, domain=Arbeidsforhold, range=Optional[Union[str, PersonalressursId]])
...
slots.Arbeidsforhold_undervisningsforhold = Slot(uri=ADM.undervisningsforhold, name="Arbeidsforhold_undervisningsforhold", curie=ADM.curie('undervisningsforhold'),
                   model_uri=DEFAULT_.Arbeidsforhold_undervisningsforhold, domain=Arbeidsforhold, range=Optional[Union[str, URIorCURIE]])
