...
URI: [https://schema.fintlabs.no/administrasjon/:gyldighetsperiode](https://schema.fintlabs.no/administrasjon/:gyldighetsperiode)
...
| ---  | ---  |
| self | https://schema.fintlabs.no/administrasjon/:gyldighetsperiode |
