...
| Artefakt | Fil |
|----------|-----|
| SHACL shapes | [bu-shapes.ttl](bu-shapes.ttl) |
| JSON-LD kontekst | [bu-context.jsonld](bu-context.jsonld) |
| JSON Schema | [bu-schema.json](bu-schema.json) |
| OWL ontologi | [bu-ontology.ttl](bu-ontology.ttl) |
| RDF/Turtle skjema | [bu-schema.ttl](bu-schema.ttl) |
| Python-klasser | [bu-model.py](bu-model.py) |
| ER-diagram (Mermaid) | [bu-erdiagram.md](bu-erdiagram.md) |
