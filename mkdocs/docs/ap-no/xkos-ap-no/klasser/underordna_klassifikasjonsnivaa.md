...
# Slot: underordna_klassifikasjonsnivaa 


_Underordna klassifikasjonsnivå (xkos:nextLevel)._
...
| ---  | ---  |
| self | xkos:nextLevel |
| native | https://data.norge.no/linkml/xkos-ap-no/underordna_klassifikasjonsnivaa |
