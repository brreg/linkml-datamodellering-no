...
# Generation date: 2026-06-08T09:38:11
...
DEFAULT_ = CurieNamespace('', 'https://data.norge.no/begrepskatalog/brreg-begrepskatalog/')
...
class Spraak(str):
    ...
    type_name = "Spraak"
    type_model_uri = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Spraak")
...
class LangString(str):
    ...
    type_model_uri = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/LangString")
...
class NonNegativeInteger(int):
    ...
    type_model_uri = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/NonNegativeInteger")
...
class Duration(str):
    ...
    type_name = "Duration"
    type_model_uri = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Duration")
...
class GYear(str):
    ...
    type_name = "GYear"
    type_model_uri = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/GYear")
...
class BegrepContainer(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/BegrepContainer")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "BegrepContainer"
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/BegrepContainer")
...
class Organisasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Organisasjon")
...
class VCardKontakt(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/VCardKontakt")
...
class AssosiativRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/AssosiativRelasjon")
...
class GeneriskRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/GeneriskRelasjon")
...
class PartitivRelasjon(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/PartitivRelasjon")
...
class Samling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Samling")
...
class Mediatype(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Mediatype")
...
class Konsept(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Konsept")
...
class Begrepssamling(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/begrepskatalog/brreg-begrepskatalog/Begrepssamling")
