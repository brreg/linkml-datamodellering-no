...
class ModellkatalogContainer(YAMLRoot):
    ...
    modellkatalogar: Optional[Union[dict[Union[str, ModellkatalogId], Union[dict, "Modellkatalog"]], list[Union[dict, "Modellkatalog"]]]] = empty_dict()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        self._normalize_inlined_as_list(slot_name="modellkatalogar", slot_type=Modellkatalog, key_name="id", keyed=True)
...
class Eigenskap(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/modellkatalog/brreg-modellkatalog/Eigenskap")
...
class Sammensetning(Eigenskap):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/modellkatalog/brreg-modellkatalog/Sammensetning")
...
class AlleAv(Valg):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/modellkatalog/brreg-modellkatalog/AlleAv")
...
class Merknad(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/modellkatalog/brreg-modellkatalog/Merknad")
...
class Betingelsesregel(Merknad):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/modellkatalog/brreg-modellkatalog/Betingelsesregel")
...
class XEllerY(Betingelsesregel):
    ...
    class_model_uri: ClassVar[URIRef] = URIRef("https://data.norge.no/modellkatalog/brreg-modellkatalog/XEllerY")
...
slots.modellkatalogContainer__modellkatalogar = Slot(uri=DEFAULT_.modellkatalogar, name="modellkatalogContainer__modellkatalogar", curie=DEFAULT_.curie('modellkatalogar'),
                   model_uri=DEFAULT_.modellkatalogContainer__modellkatalogar, domain=None, range=Optional[Union[dict[Union[str, ModellkatalogId], Union[dict, Modellkatalog]], list[Union[dict, Modellkatalog]]]])

slots.modellkatalogContainer__informasjonsmodellar = Slot(uri=DEFAULT_.informasjonsmodellar, name="modellkatalogContainer__informasjonsmodellar", curie=DEFAULT_.curie('informasjonsmodellar'),
                   model_uri=DEFAULT_.modellkatalogContainer__informasjonsmodellar, domain=None, range=Optional[Union[dict[Union[str, InformasjonsmodellId], Union[dict, Informasjonsmodell]], list[Union[dict, Informasjonsmodell]]]])

slots.modellkatalogContainer__objekttypar = Slot(uri=DEFAULT_.objekttypar, name="modellkatalogContainer__objekttypar", curie=DEFAULT_.curie('objekttypar'),
                   model_uri=DEFAULT_.modellkatalogContainer__objekttypar, domain=None, range=Optional[Union[dict[Union[str, ObjekttypeId], Union[dict, Objekttype]], list[Union[dict, Objekttype]]]])
...
slots.modellkatalogContainer__eigenskapar = Slot(uri=DEFAULT_.eigenskapar, name="modellkatalogContainer__eigenskapar", curie=DEFAULT_.curie('eigenskapar'),
                   model_uri=DEFAULT_.modellkatalogContainer__eigenskapar, domain=None, range=Optional[Union[dict[Union[str, EigenskapId], Union[dict, Eigenskap]], list[Union[dict, Eigenskap]]]])

slots.modellkatalogContainer__aktorer = Slot(uri=DEFAULT_.aktorer, name="modellkatalogContainer__aktorer", curie=DEFAULT_.curie('aktorer'),
                   model_uri=DEFAULT_.modellkatalogContainer__aktorer, domain=None, range=Optional[Union[dict[Union[str, AktorId], Union[dict, Aktor]], list[Union[dict, Aktor]]]])
