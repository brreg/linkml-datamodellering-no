...
| [ModellkatalogContainer](modellkatalogcontainer.md) | [aktorer](aktorer.md) | range | [Aktor](aktor.md) |
...
```yaml
id: https://example.org/kontakt/modellforvaltning
namn_aktor:
- Eksempelorganisasjon – Modellforvaltning
