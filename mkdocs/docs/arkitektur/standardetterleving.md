...
Gap 1, 2, 5 og 6 er reelle, avgrensa utvidingspunkt eller feil; gap 3 og 4 er
presisjonsfiksar utan funksjonell konsekvens. Gap 7 (nøkkelnamn-mismatch i
...
modellkatalog-skjema) er lukka — sjå `specs/done/fiks-dqv-measurements-data-policy-nokkel.md`
og `specs/done/fiks-dqv-gap-7a-7b.md`. Gap 8 er eit nytt, lågt prioritert
