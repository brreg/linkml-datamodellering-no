...
| 3 | Dokumenter kryssreferanse til Digdirs Person/Enhet-modell i `description.md` for `ngr-person`/`enhetsregisteret-bvrinnfelles` | Person og Enhet — felles informasjonsmodell | Låg — dokumentasjon |
