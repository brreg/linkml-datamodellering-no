...
!!! note "Beskrivelse"
    ...
    Dette dokumentet viser det komplette importhierarkiet for alle skjemaer i repoet.
...
imports:
  ...
  - https://raw.githubusercontent.com/brreg/linkml-datamodellering-no/ngr-adresse-v1.6.0/src/linkml/ngr/ngr-adresse/ngr-adresse-schema  # domenemodell (versjonslåst via git tag)
```
