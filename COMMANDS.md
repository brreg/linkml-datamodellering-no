...
| <a id="gen-java"></a>`make gen-java [DOMAIN=...] [SCHEMA=...]` | Java-klassar (Lombok `@Data`, berre skjema med `java: true` i build.yaml) | `generated/<domain>/<modell>/java/*.java` | Batcha — `batch-generate.py --generator java` |
