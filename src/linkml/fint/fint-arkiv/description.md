LinkML-modell av FINT Arkiv-API, konvertert frå FINT sin Java-baserte modell.

Modellen definerer `Saksmappe`, `Journalpost`, `Dokumentbeskrivelse`, `Arkivdel` og andre arkivklasser for integrasjon med FINT Arkiv-tenester (Noark 5-basert).
