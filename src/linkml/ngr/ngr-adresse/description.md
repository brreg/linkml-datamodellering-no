LinkML-modell av Nasjonale grunndata - Adresse, modellert som ein domenemodell for norske adressar.

Modellen definerer `OffisiellAdresse`, `Postboksadresse` og tilhøyrande geografiske inndelingar (`Kommune`, `Fylke`, `Poststed`) og adressekomponentar (`Adressenavn`, `Gate`, `Vegnummer` m.fl.).
