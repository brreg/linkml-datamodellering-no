...
|---|---|---|---|---|---|
| `schema.id` til stades | error | — (alt error) | [4 — Identifiserbarheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#identifiserbarhet) | [F1](https://www.go-fair.org/fair-principles/) | Persistent identifikator for skjemaet |
| `schema.id` er HTTP(S)-URI | error | — (alt error) | [4 — Identifiserbarheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#identifiserbarhet) | [F1](https://www.go-fair.org/fair-principles/) | Sikrar at identifikatoren er ein oppløyseleg URI |
...
| Sjekk | Alvor | Oppgraderer til | Digdir-regel | FAIR | Skildring |
|---|---|---|---|---|---|
| `schema.annotations.utgiver` er URI på forma `https://data.norge.no/organizations/<orgnr>` | warning | error (gull) | [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [R1.2](https://www.go-fair.org/fair-principles/) | Identifiserer kven som har ansvar for modellen |
| `schema.annotations.endringsdato` er ISO 8601-dato | warning | error (gull) | [9 — Datering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#datering) | [R1.3](https://www.go-fair.org/fair-principles/) | Datering av siste endring |
| `schema.annotations.status` er ADMS Status-URI | warning | error (gull) | [11 — Modellstatus](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#modellstatus) | [R1.3](https://www.go-fair.org/fair-principles/) | Eksplisitt livssyklusstatus (`UnderDevelopment`/`Completed`/`Deprecated`/`Withdrawn`) |
| Skjemaet importerer `dqv-ap-no-schema` (direkte eller transitivt) | warning | error (gull) | [14 — Gjenbruk](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#gjenbruk) | [I3](https://www.go-fair.org/fair-principles/) | Gjenbruk av kvalitetsvokabularet (Kvalitetsmaal, Kvalitetsmaaling m.fl.) i staden for eigne tilsvarande klassar/slots |
| `Katalog` har `dct:title` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, R1.2](https://www.go-fair.org/fair-principles/) | Tittel på katalogen |
| `Katalog` har `dct:description` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, R1.2](https://www.go-fair.org/fair-principles/) | Skildring av katalogen |
| `Katalog` har `dcat:contactPoint` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, R1.2](https://www.go-fair.org/fair-principles/) | Kontaktpunkt for katalogen |
...
| `Katalogpost` har `dct:modified` | error | — (alt error) | [9 — Datering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#datering) | [R1.3](https://www.go-fair.org/fair-principles/) | Endringsdato for katalogposten |
| `Katalogpost` har `foaf:primaryTopic` | error | — (alt error) | [9 — Datering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#datering) | [R1.3](https://www.go-fair.org/fair-principles/) | Kopling til hovudressursen katalogposten skildrar |
| `Datasett` har `dct:title` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, R1.2](https://www.go-fair.org/fair-principles/) | Tittel på datasettet |
...
| `Datasett` har `dcat:contactPoint` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, R1.2](https://www.go-fair.org/fair-principles/) | Kontaktpunkt for datasettet |
| `Datasett` har `dcat:theme` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, R1.2](https://www.go-fair.org/fair-principles/) | Tema/kategori for datasettet (Los) |
...
| `Datasett` har `dct:accessRights` | warning | error (gull) | — | — | Tilgangsnivå for datasettet — svarar til trafikklyssystemet (grøn/gul/raud) i Digdir sin veileder [«Orden i eget hus», steg 4](https://www.digdir.no/informasjonsforvaltning/steg-4-vurdere-tilgangsniva/2723) |
| `Datasett` har `dcatap:applicableLegislation` | warning | error (gull) | — | — | Gjeldande lovgjeving (lovheimel) for tilgang til datasettet — same steg som over |
| `Distribusjon` har `dcat:accessURL` | error | — (alt error) | — | [A1](https://www.go-fair.org/fair-principles/) | Tilgangsadresse til distribusjonen |
| `Distribusjon` har slot med `dct:license` | warning | error (gull) | [7 — Tilgjengeleggjering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#tilgjengeliggjring) | [R1.1](https://www.go-fair.org/fair-principles/) | Lisens på distribusjonsnivå. Sjå eiga merknad om dei tre «lisens»-sjekkane under § gold |
| `Datatjeneste` har `dcat:endpointURL` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, A1, R1.2](https://www.go-fair.org/fair-principles/) | Endepunkt-URL for tenesta |
| `Datatjeneste` har `dcat:contactPoint` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, A1, R1.2](https://www.go-fair.org/fair-principles/) | Kontaktpunkt for tenesta |
| `Datatjeneste` har `dct:title` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet), [2 — Meiningsfullheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#meningsfullhet), [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [F2, A1, R1.2](https://www.go-fair.org/fair-principles/) | Tittel på tenesta |
...
| `Aktør` har `foaf:name` | error | — (alt error) | [1 — Forståelighet](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#forstelighet) | [F2](https://www.go-fair.org/fair-principles/) | Navn på aktøren |
| Containerklassen (`tree_root`) har attributt med range `Katalog`, `Datasett`, `Kvalitetsmaal`, `Kvalitetsmaaling` | error | — (alt error) | — | — | Sikrar at hovudklassene i DCAT-AP-NO/DQV-AP-NO er kopla til containeren |
| Containerklassen har attributt med range `Distribusjon`, `Datatjeneste`, `Kvalitetsdimensjon`, `Kvalitetsmerknad` | warning | error (gull) | — | — | Sikrar at støtteklassene er kopla til containeren |
| Instansverdiar for slots med `vokabular_pattern` matchar regex-mønsteret **(krev `INSTANCE=`)** | error/warning/info | N/A (avheng av `vokabular_krav`, ikkje ein nivå-oppgradering) | [8 — Maskinprosserbarheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#maskinprosserbarhet) | [I1](https://www.go-fair.org/fair-principles/) | Kode: `instance_slot_invalid_vocabulary_pattern`. Alvor avheng av `vokabular_krav`: **error** for `skal`, **warning** for `bør`, **info** for `kan` |
| Instansverdiar er frå korrekt vokabular-domene (`gyldige_verdier`) **(krev `INSTANCE=`)** | error/warning | N/A (avheng av `vokabular_krav`, ikkje ein nivå-oppgradering) | [8 — Maskinprosserbarheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#maskinprosserbarhet) | [I1](https://www.go-fair.org/fair-principles/) | Kode: `instance_slot_invalid_vocabulary_domain`. Sjekkar at URI-ar startar med `gyldige_verdier`-domenet |
...
|---|---|---|---|---|---|
| `schema.id` til stades | error | Bronse (alt error) | [4 — Identifiserbarheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#identifiserbarhet) | [F1](https://www.go-fair.org/fair-principles/) | Persistent identifikator for skjemaet |
| `schema.id` er HTTP(S)-URI | error | Bronse (alt error) | [4 — Identifiserbarheit](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#identifiserbarhet) | [F1](https://www.go-fair.org/fair-principles/) | Sikrar at identifikatoren er ein oppløyseleg URI |
...
| Skjemaet har ein slot med `dct:license` | error | Ny på gull | [7 — Tilgjengeleggjering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#tilgjengeliggjring) | [R1.1](https://www.go-fair.org/fair-principles/) | Lisensinformasjon er føresetnad for gjenbruk. Sjå eiga merknad om dei tre «lisens»-sjekkane rett under tabellen |
| Skjemaet har ein slot for proveniens (`prov:wasAttributedTo`, `prov:wasGeneratedBy`, `dct:creator`, `dct:publisher` eller `dct:contributor`) | error | Ny på gull | [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [R1.2](https://www.go-fair.org/fair-principles/) | Proveniens er viktig for tillit til og gjenbruk av data. For AP-NO-konforme skjema er dette allereie automatisk dekt av dei obligatoriske `dct:publisher`-krava på `Katalog`/`Datasett`/`Datatjeneste` — reell tilleggsverdi berre for skjema utanfor AP-NO-domenemønsteret |
| `schema.annotations.utgiver` til stades | error | Sølv → gull | [10 — Ansvar](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#ansvar) | [R1.2](https://www.go-fair.org/fair-principles/) | URI til ansvarleg organisasjon |
| `schema.annotations.endringsdato` til stades | error | Sølv → gull | [9 — Datering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#datering) | [R1.3](https://www.go-fair.org/fair-principles/) | ISO 8601-dato for siste endring |
| `schema.annotations.oppdateringsfrekvens` til stades | error | Sølv → gull | [9 — Datering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#datering) | [R1.3](https://www.go-fair.org/fair-principles/) | URI frå EU sin Frequency Named Authority List |
| `schema.annotations.status` til stades | error | Sølv → gull | [11 — Modellstatus](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#modellstatus) | [R1.3](https://www.go-fair.org/fair-principles/) | ADMS Status-URI for modellstatus |
| `Distribusjon` har slot med `dct:license` | error | Sølv → gull | [7 — Tilgjengeleggjering](https://www.digdir.no/informasjonsforvaltning/felles-modelleringsregler-offentlig-forvaltning/3029#tilgjengeliggjring) | [R1.1](https://www.go-fair.org/fair-principles/) | Lisens på distribusjonsnivå. Sjå eiga merknad om dei tre «lisens»-sjekkane rett under tabellen |
| `Datasett` har `dct:accessRights` | error | Sølv → gull | — | — | Tilgangsnivå (trafikklyssystemet) |
| `Datasett` har `dcatap:applicableLegislation` | error | Sølv → gull | — | — | Lovheimel for tilgang |
| Containerklassen har attributt med range `Distribusjon` | error | Sølv → gull | — | — | — |
| Containerklassen har attributt med range `Datatjeneste` | error | Sølv → gull | — | — | — |
| Containerklassen har attributt med range `Kvalitetsdimensjon` | error | Sølv → gull | — | — | — |
...
>
> - **`schema.license` til stades** — er skjemaet **sjølv** (artefaktet) lisensiert?
> - **Skjemaet har ein slot med `dct:license`** (`r11_license`) — finst det **ein slot kvar som helst**
>   i modellen som let instansar uttrykkje lisensinformasjon?
> - **`Distribusjon` har slot med `dct:license`** (`distribusjon_lisens`) — har **spesifikt** `Distribusjon`
>   ein slik slot?
>
> Eit skjema som består den siste (meir spesifikke) sjekken vil automatisk bestå den midterste òg, sidan
> `Distribusjon` sin `dct:license`-slot tel som «ein slot kvar som helst». Dette er forventa, ikkje ein feil.
